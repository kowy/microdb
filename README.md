# MicroDB
[![Test Status](https://github.com/escapace/typescript-library-starter/workflows/Test/badge.svg?branch=master)](https://github.com/kowy/microdb/actions?query=workflow:Test+branch:master)
...
### Create instance
To use MicroDb import it and create MicroDb instance:
```ts
// Typescript
import MicroDb from "microdb"
const db = new MicroDb("my-db", {})
```
...
On the other hand, if the document doesn't have an _id attribute or is empty, MicroDB will generate this _id and save the document to DB.

**Parameters**
* doc [any] - your document, which should be stored in MicroDB
...
**Parameters**
* docs [array of any] - your documents, which should be stored in MicroDB
